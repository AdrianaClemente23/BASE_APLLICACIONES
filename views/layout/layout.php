            ...
            <div class="collapse navbar-collapse" id="navbarToggler">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin: 0;">
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a class="nav-link px-3" style="border: none; background: none;" href="/clementeperez/asigpermisos">
                            <i class="bi bi-box-arrow-in-right me-2"></i>Asignacion Permisos
                        </a>
                    </li>
                ...
                <div class="col-lg-1 d-grid mb-lg-0 mb-2">
                    <a href="/clementeperez/inicio" class="btn btn-danger"><i class="bi bi-arrow-bar-left"></i>MENÚ</a>
                </div>
